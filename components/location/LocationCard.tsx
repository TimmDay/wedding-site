...
import { convertTimeToUserTZ, convertTimeToUserTZWithDay } from '../../utils/tz-conversion-utils';
        ...
        >
            ...
            {start &&
                <div className="time-block">
                    <p>
                        {`${start && convertTimeToUserTZWithDay(start)} - ${end && convertTimeToUserTZ(end)}`}
                    </p>
                </div>
            }
        </StyledLocationCard>
